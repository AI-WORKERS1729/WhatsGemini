...
default_prompt="Respond to the following message in a friendly tone with emojis and a relaxed vibe, just like a real human would in the same language as the user asked. The response should be short, cheerful, and engaging without extra details."
    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            if fetched_message:
                ...
                output_text = await generate_reply(f"{default_prompt} {input_text}")
